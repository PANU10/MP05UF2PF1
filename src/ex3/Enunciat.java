    ...
    3. Per a millorar el rendiment de la nostra taula de hash en modificarem la implementació perquè no hi hagi
       col·lisions:
         a. Quan es detecta col·lisió, s'ha de crear una nova taula de hash amb el doble d'espai que l'actual
            (INITIAL_SIZE * 2)
         b. Totes les dades de la taula anterior es copien a la nova.
         c. S'inserta la nova dada a la nova taula.

    4. Explica els canvis que has hagut de fer amb comentaris de tipus -> MILLORA: he creat un... però NO ESBORRIS CODI!
       Tan sols comenta'l si has de fer neteja, perquè es pugui veure el codi antic i el codi nou.

    4. Si hi apliques refacció (opcional), comenta-ho amb -> REFACCIÓ: he aplicat el mètode de refacció...
